...
public class PtpSetFlashModeRequest extends UsbRequest {
	...
	public PtpSetFlashModeRequest(PtpCamera in_driver, FlashMode in_value) {
		super("PtpSetFlashModeRequest");
		driver = in_driver;
		value = in_value;
		assert(null != driver);
		assert(null != value);
